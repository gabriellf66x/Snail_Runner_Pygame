...
def display_score():
    ...
    score_surf_0 = font.render(f'Score: {current_time}', False, (64, 64, 64))
    score_rect_1 = score_surf.get_rect(center=(430, 50))
    screen.blit(score_surf_0, score_rect_1)
    return current_time
...
score_surf = font.render("SNAIL RUNNER!!!", False, 'Black')
...
title_surf = font.render('Snail Runner', False, 'White')
title_rect = title_surf.get_rect(center=(400, 80))
instr_surf = font.render("Press Space to Jump", False, 'White')
